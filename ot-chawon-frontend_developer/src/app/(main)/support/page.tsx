...
export default function SupportPage() {
  return (
    <main className="max-w-screen-md mx-auto px-4 py-12">
      <h1 className="text-2xl font-bold text-oc-gray-900 mb-8">고객지원</h1>
      <div className="rounded-lg border border-oc-gray-200 bg-white p-6 text-oc-gray-600 space-y-6">
        <section>
          <h2 className="text-base font-semibold text-oc-gray-900 mb-2">문의하기</h2>
        ...
        <section>
          <h2 className="text-base font-semibold text-oc-gray-900 mb-2">자주 묻는 질문</h2>
