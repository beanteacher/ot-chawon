...
export default function TermsPage() {
  return (
    <main className="max-w-screen-md mx-auto px-4 py-12">
      <h1 className="text-2xl font-bold text-white mb-8">서비스 이용약관</h1>
      ...
      <div className="rounded-lg border border-oc-gray-700 bg-oc-gray-900 p-6 text-oc-gray-300 space-y-6">
        ...
        <section>
          <h2 className="text-base font-semibold text-white mb-2">제2조 (정의)</h2>
          <p className="text-sm leading-relaxed">
        ...
        <section>
          <h2 className="text-base font-semibold text-white mb-2">제3조 (약관의 효력 및 변경)</h2>
          <p className="text-sm leading-relaxed">
        ...
        <section>
          <h2 className="text-base font-semibold text-white mb-2">제4조 (서비스 이용)</h2>
          <p className="text-sm leading-relaxed">
      ...
      <div className="mt-6">
        <Link
          href="/"
          className="inline-flex h-10 items-center justify-center rounded-md border border-oc-gray-700 bg-oc-gray-900 px-5 text-sm font-medium text-oc-gray-300 transition-colors hover:bg-oc-gray-800"
        >
          홈으로
        </Link>
      </div>
